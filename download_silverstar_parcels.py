...
covering Silver Star / Vernon area, reproject to EPSG:32610, and save as shapefile.
"""
...
OUTPUT_DIR = "/home/jeremy/COMP4900_Project_backup_files/silver_star_parcels"
OUTPUT_SHP = os.path.join(OUTPUT_DIR, "silver_star_parcels.shp")

# Silver Star / Vernon area bounding box in WGS84 (EPSG:4326)
# Covers the Silver Star imagery extent
LON_MIN, LON_MAX = -119.12, -118.95
LAT_MIN, LAT_MAX = 50.32, 50.42
...
def main():
    tmpdir = tempfile.mkdtemp(prefix="pmbc_ss_")
