...
# Output directory
OUT_DIR = Path("/home/jeremy/COMP4900_Project_backup_files/logan_lake_imagery")

# Logan Lake, BC bounds (lat/lon)
# Covers the town and surrounding residential areas
AREA_BOUNDS = {
    "west": -120.85,
    "east": -120.68,
    "south": 50.45,
...
def main():
    ...
    print(f"Logan Lake WMS Imagery Downloader")
    print(f"==================================")
    ...
    for lon_idx in range(lon_steps):
        for lat_idx in range(lat_steps):
            ...
            tile_name = f"ll_{lon_idx:03d}_{lat_idx:03d}.tif"
